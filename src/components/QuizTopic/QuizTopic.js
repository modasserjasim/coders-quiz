        ...
        <div className="rounded-md shadow-md ">
            ...
            <div className="p-4 ">
                <div className='flex justify-between items-center flex-wrap'>
                    ...
                    <h3 className='text-xl'>Questions: <span className='text-cyan-500 font-bold'>{total}</span></h3>
                </div>
                <div>
                    <Link to={`/quiz/${id}`} type="button" className="flex items-center justify-center p-2 font-semibold tracking-wide rounded-md bg-cyan-400 text-gray-900 mt-3">
                        Start Quiz
